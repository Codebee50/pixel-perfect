...
const ServiceCard = (props) => {
  ...
  return (
    <motion.div className="flex flex-col items-start border border-[#e4dff7] p-5 rounded-md h-max"
    initial={{opacity:0, y:-50}}
    whileInView={{opacity:1, y:0}}
    transition={{ease:'easeIn', type:'spring', duration:2 ,delay:0.3*props.index}}
    viewport={{once:true}}>
      <div className="bg-green100 p-2 rounded-md">
